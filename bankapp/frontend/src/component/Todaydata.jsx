    ...
    <div className="flex flex-col gap-3">
      ...
      {todayData.map((el, idx) => {
        return (
          <div
            key={idx + el.title}
            className="flex justify-between border bg-white rounded-xl items-center px-6 py-3"
          >
            <div className="flex gap-4 items-center">
              ...
              />
              <div className=" w-10 h-10 bg-[#0166FF] rounded-full items-center flex justify-center">
                {" "}
                <ForkKnife />
              </div>
              <div>
