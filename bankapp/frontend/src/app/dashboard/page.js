...
export default function Dashboard() {
  return (
    <div className=" flex flex-col">
      <Navbar />
      <div className="flex flex-col  gap-6 px-[120px] py-8 bg-[#F3F4F6]">
        <div className="flex justify-between">
          <div className=" flex flex-col justify-between p-8 w-[384px] h-[219px] rounded-[18px] bg-[#0166FF]" style={{
              backgroundImage:
            ...
            backgroundSize: "cover"
                ...
                <div className="items-center gap-2 p-[4.7px] inline-flex"><Logo /><Geld /></div>
                <div className=" flex justify-between items-center"><div className="inline-flex flex-col text-white"><p className=" opacity-50">Cash</p> <span className=" text-2xl">10,000,000</span></div> <Cashlogo /></div>
          </div>

          <div className=" flex flex-col w-[384px] h-[219px] rounded-[18px] bg-white" >
                <div className=" flex gap-2 px-6 py-4 items-center border-b border-[#E2E8F0] font-semibold"><GreenCircle/><p>Your Income</p></div>
                <div className=" flex flex-col px-6 pt-5 pb-6 items-start gap-6">
                    <div>    
                        <div className="flex text-4xl font-semibold gap-1">
                        <h1>1,200,000</h1><span>₮</span>
                        </div> 
          ...
          <div className=" flex flex-col w-[384px] h-[219px] rounded-[18px] bg-white" >
                <div className=" flex gap-2 px-6 py-4 items-center border-b border-[#E2E8F0] font-semibold"><BlueCircle/><p>Total Expenses</p></div>
                <div className=" flex flex-col px-6 pt-5 pb-6 items-start gap-6">
                    <div>    
                        <div className="flex text-4xl font-semibold gap-1">
                        <h1>-1,200,000</h1><span>₮</span>
        ...
        <div className="flex justify-between w-full gap-6">
            <div className=" flex flex-col w-2/4  rounded-[18px] bg-white" >
                <div className=" flex gap-2 px-6 py-4 items-center border-b border-[#E2E8F0] font-semibold"><p>Income - Expense</p></div>
          ...
          <div className=" flex flex-col w-2/4 h-[226px] rounded-[18px] bg-white" >
                <div className=" flex gap-2 px-6 py-4 items-center border-b border-[#E2E8F0] justify-between font-semibold"><p>Income - Expense</p><p>Jun 1 - Nov 30</p></div>
                <div className=" flex flex-col px-6 py-8">
        ...
        <div className=" flex flex-col w-full h-[226px] rounded-[18px] bg-white" >
                <div className=" flex gap-2 px-6 py-4 items-center border-b border-[#E2E8F0] justify-between font-semibold"><p>Last Records</p></div>
                <div className=" flex flex-col px-6 py-8">
                    <House/>
                </div>
          </div>
