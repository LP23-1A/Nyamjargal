...
export default function Login() {
  ...
  return (
    <div
      className=" flex flex-col gap-28 w-screen h-screen justify-center items-center"
      ...
      <div className=" flex justify-center items-center font-roboto bg-transparent border-[2px] border-[#D1D5DB]/20 backdrop-blur-xl shadow shadow-blue-500/40 text-white rounded-xl py-8 px-10">
        <div className=" flex w-[384px] flex-col gap-[40px] justify-center items-center">
          <div className=" flex flex-col gap-2 items-center">
            <h2 className=" font-semibold leading-8 text-[36px]">
              Welcome Back
            </h2>
          ...
          <div className="flex flex-col gap-4 w-full">
            <input
              ...
              className=" h-12 bg-transparent rounded-[40px] border-[2px] outline-none border-[#D1D5DB]/20 p-4 placeholder:text-white/60"
              required
            />
            <input
              type="password"
              ...
              className=" h-12 bg-transparent rounded-[40px] border-[2px] border-[#D1D5DB]/20 p-4 placeholder:text-white/60"
              required
            />
            <button
              className="bg-[#fff] text-[#333] rounded-[20px] h-8"
              onClick={handler}
            >
              {" "}
              Log in{" "}
          ...
          <div className="flex">
            ...
            <button
              className=" text-[#FFFF00] px-3 rounded-3xl"
